...
const index_js_1 = require("@volar/language-service/index.js");
...
const registerFeatures_js_1 = require("./utils/registerFeatures.js");
const serverConfig_js_1 = require("./utils/serverConfig.js");
...
function startCommonLanguageServer(connection, _plugins, getRuntimeEnv) {
    ...
    connection.onInitialize(async (_params) => {
        ...
        context = {
            server: {
                ...
                plugins: _plugins,
                configurationHost: initParams.capabilities.workspace?.configuration ? (0, configurationHost_js_1.createConfigurationHost)(initParams, connection) : undefined,
        ...
        documents = (0, documents_js_1.createDocuments)(context.server.runtimeEnv, connection);
        if (options.l10n) {
        ...
        (0, registerFeatures_js_1.setupCapabilities)(result.capabilities, options, plugins, getSemanticTokensLegend(), config.services ?? {});
    ...
    connection.onInitialized(async () => {
        ...
        if (options.serverMode !== types_js_1.ServerMode.Syntactic
    ...
    async function createLanguageServiceHost() {
        workspaces = (0, workspaces_js_1.createWorkspaces)({
            ...context,
            workspaces: {
                ts,
                tsLocalized,
